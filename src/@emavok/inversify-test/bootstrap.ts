...
import { DI_USER_CONTROLLER } from './user/user.types';
...
// ------------------------------------------------------------------------------------------------
APP_CONTAINER.rebind<IApiController>(DI_USER_CONTROLLER).to(AnotherUserController);

// ------------------------------------------------------------------------------------------------
// bind public api mapping constant
// ------------------------------------------------------------------------------------------------
const PUBLIC_ENDPOINTS: IEndpointMapping[] = [
    { path: '/', router: (APP_CONTAINER.get<IApiController>(DI_USER_CONTROLLER)).getRouter() }
];
